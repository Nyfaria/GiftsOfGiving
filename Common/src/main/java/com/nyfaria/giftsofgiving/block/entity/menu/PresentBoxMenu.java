package com.nyfaria.giftsofgiving.block.entity.menu;
...
public class PresentBoxMenu extends AbstractContainerMenu {
    ...
    private Component gifter;
    private Component giftee;

    public PresentBoxMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, new SimpleContainer(27));
    }

    public PresentBoxMenu(int pContainerId, Inventory pPlayerInventory, Container pContainer) {
        super(MenuInit.PRESENT_BOX.get(), pContainerId);
    ...
    public Component getGifter() {
        return gifter;
    }

    public void setGifter(Component gifter) {
        this.gifter = gifter;
    }

    public Component getGiftee() {
        return giftee;
    }

    public void setGiftee(Component giftee) {
        this.giftee = giftee;
    }
